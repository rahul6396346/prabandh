...
const DeanSidebar = ({ isCollapsed, setIsCollapsed }: SidebarProps) => {
  ...
  const navItems: NavItem[] = [
    { name: "DASHBOARD", icon: <LayoutDashboard size={20} />, path: "/dean/dashboard" },
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Leave Approvals", path: "/dean/approvals/leave" },
        { name: "Approved Requests", path: "/dean/approvals/approved" },
        { name: "Rejected Requests", path: "/dean/approvals/rejected" },
        { name: "All Requests", path: "/dean/approvals/all" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Academic Overview", path: "/dean/academics/overview" },
        { name: "Curriculum Development", path: "/dean/academics/curriculum" },
        { name: "Academic Programs", path: "/dean/academics/programs" },
        { name: "Academic Calendar", path: "/dean/academics/calendar" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Faculty Directory", path: "/dean/faculty/directory" },
        { name: "Faculty Coordination", path: "/dean/faculty/coordination" },
        { name: "Performance Reviews", path: "/dean/faculty/performance" },
        { name: "Faculty Development", path: "/dean/faculty/development" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Student Services", path: "/dean/students/services" },
        { name: "Academic Progress", path: "/dean/students/progress" },
        { name: "Student Grievances", path: "/dean/students/grievances" },
        { name: "Student Activities", path: "/dean/students/activities" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Academic Performance", path: "/dean/reports/academic" },
        { name: "Faculty Reports", path: "/dean/reports/faculty" },
        { name: "Student Analytics", path: "/dean/reports/students" },
        { name: "Program Assessment", path: "/dean/reports/programs" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Academic Quality", path: "/dean/quality/academic" },
        { name: "Accreditation", path: "/dean/quality/accreditation" },
        { name: "Assessment Tools", path: "/dean/quality/assessment" },
        { name: "Quality Reports", path: "/dean/quality/reports" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Create Notice", path: "/dean/notices/create" },
        { name: "View All Notices", path: "/dean/notices/view" },
        { name: "Notice Templates", path: "/dean/notices/templates" }
      ]
    },
    ...
    { 
      ...
      isSeparator: true,
      dropdownItems: [
        { name: "Dean Profile", path: "/dean/profile" },
        { name: "Account Settings", path: "/dean/account-settings" },
        { name: "Security & Privacy", path: "/dean/security" }
      ]
    },
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Change Password", path: "/dean/password/change" },
        { name: "Reset Password", path: "/dean/password/reset" }
      ]
    },
        ...
        {!isCollapsed ? (
          <div className="flex items-center gap-3">
            ...
            <div className="truncate">
              <p className="text-sm font-medium truncate">Dean Portal</p>
