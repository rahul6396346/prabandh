...
const DeputyRegistrarHeader = ({ title = "ITM University, Gwalior" }: HeaderProps) => {
          ...
          {openDropdown === 'notifications' && (
            <div className="absolute right-0 top-full mt-3 w-80 bg-white shadow-md rounded-sm border z-50 text-gray-800">
              <div className="p-4 flex justify-center">
                <Link to="/deputy_registrar/notices" className="text-[#8B0000] hover:underline flex items-center">
                  See All Notices &gt;
                </Link>
              </div>
            </div>
        ...
        <div className="relative">
          ...
          {openDropdown === 'profile' && (
            <div className="absolute right-0 top-full mt-3 w-64 bg-white shadow-md rounded-sm border z-50 text-gray-800">
              ...
              <div className="py-2">
                <Link to="/deputy_registrar/profile" className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50">
                  <User size={18} />
                  <span>Deputy Registrar Profile</span>
                </Link>
                <Link to="/deputy_registrar/change-password" className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50">
                  <Lock size={18} />
...
export default DeputyRegistrarHeader; 