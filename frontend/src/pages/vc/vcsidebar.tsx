...
const VCSidebar = ({ isCollapsed, setIsCollapsed }: SidebarProps) => {
  ...
  const navItems: NavItem[] = [
    { name: "DASHBOARD", icon: <LayoutDashboard size={20} />, path: "/vc/dashboard" },
    { name: "EVENT APPROVALS", icon: <FileQuestion size={20} />, path: "/vc/event-approvals" },
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Leave Approvals", path: "/vc/approvals/leave" },
        { name: "Approved Requests", path: "/vc/approvals/approved" },
        { name: "Rejected Requests", path: "/vc/approvals/rejected" },
        { name: "All Requests", path: "/vc/approvals/all" }
      ]
    },
    { 
      name: "ADMINISTRATION", 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "VC Profile", path: "/vc/profile" },
        { name: "Executive Committee", path: "/vc/administration/executive-committee" },
        { name: "Faculty Performance", path: "/vc/administration/faculty-performance" },
        { name: "Staff Performance", path: "/vc/administration/staff-performance" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Academic Reports", path: "/vc/reports/academic" },
        { name: "Financial Reports", path: "/vc/reports/financial" },
        { name: "Faculty Reports", path: "/vc/reports/faculty" },
        { name: "Student Analytics", path: "/vc/reports/students" },
        { name: "Performance Analytics", path: "/vc/reports/performance" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "University Goals", path: "/vc/strategic/goals" },
        { name: "Budget Planning", path: "/vc/strategic/budget" },
        { name: "Policy Development", path: "/vc/strategic/policies" },
        { name: "Quality Assurance", path: "/vc/strategic/quality" }
      ]
    },
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Create Notice", path: "/vc/notices/create" },
        { name: "View All Notices", path: "/vc/notices/view" },
        { name: "Notice Templates", path: "/vc/notices/templates" }
      ]
    },
    { name: "NOTESHEET", icon: <FileText size={20} />, path: "/vc/notesheet" },
    ...
    { 
      ...
      dropdownItems: [
        { name: "VC Profile", path: "/vc/profile" },
        { name: "Account Settings", path: "/vc/account-settings" },
        { name: "Security & Privacy", path: "/vc/security" }
      ]
    },
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "Change Password", path: "/vc/password/change" },
        { name: "Student Password", path: "/vc/password/student" }
      ]
    },
        ...
        {!isCollapsed ? (
          <div className="flex items-center gap-3">
            ...
            <div className="truncate">
              <p className="text-sm font-medium truncate">VC Portal</p>
